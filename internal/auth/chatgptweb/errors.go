...
func SafeLifecycleReason(value string) string {
	...
	case "authentication_failed",
		...
		"advanced_security_credential_invalid",
		"advanced_security_state_persist_failed",
		"advanced_security_challenge_unavailable",
		"advanced_security_credential_not_allowed",
		"advanced_security_assertion_invalid",
		"advanced_security_verification_failed",
		"advanced_security_finalize_failed",
