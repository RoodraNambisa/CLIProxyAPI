...
// GCPProject is retained for v6 source compatibility with the removed Gemini CLI login flow.
type GCPProject struct {
	Projects []GCPProjectProjects `json:"projects"`
}

// GCPProjectLabels is retained for v6 source compatibility with the removed Gemini CLI login flow.
type GCPProjectLabels struct {
	GenerativeLanguage string `json:"generative-language"`
}

// GCPProjectProjects is retained for v6 source compatibility with the removed Gemini CLI login flow.
